    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressTown", x => new { x.AddressesId, x.TownsId });
                    table.ForeignKey(
                        name: "FK_AddressTown_Addresses_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AddressTown_Towns_TownsId",
                        column: x => x.TownsId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ThumbnailExtension = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    AvatarExtension = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    FacebookUrl = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    InstagramUrl = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    TikTokUrl = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    TwitterUrl = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    WebsiteUrl = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowersFollowees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FollowersFollowees_AspNetUsers_FolloweeId",
                        column: x => x.FolloweeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FollowersFollowees_AspNetUsers_FollowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowersFollowees_FolloweeId",
                table: "FollowersFollowees",
                column: "FolloweeId");

            migrationBuilder.CreateIndex(
                name: "IX_FollowersFollowees_FollowerId",
                table: "FollowersFollowees",
                column: "FollowerId");

            migrationBuilder.CreateIndex(
                name: "IX_FollowersFollowees_IsDeleted",
                table: "FollowersFollowees",
                column: "IsDeleted");
