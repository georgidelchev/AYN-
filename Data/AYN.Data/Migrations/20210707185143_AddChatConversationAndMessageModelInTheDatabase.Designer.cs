...
namespace AYN.Data.Migrations
{
    ...
    [Migration("20210707185143_AddChatConversationAndMessageModelInTheDatabase")]
    partial class AddChatConversationAndMessageModelInTheDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AYN.Data.Models.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AYN.Data.Models.Message", b =>
                {
                    ...
                    b.Property<int?>("ChatConversationId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChatConversationId1");
            ...
            modelBuilder.Entity("AYN.Data.Models.Message", b =>
                {
                    b.HasOne("AYN.Data.Models.ChatConversation", "ChatConversation")
                        .WithMany("Messages")
                        .HasForeignKey("ChatConversationId1");
